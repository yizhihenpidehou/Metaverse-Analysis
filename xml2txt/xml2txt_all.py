...
class WorkHandler( xml.sax.ContentHandler ):
    ...
    def endElement(self, tag):
        ...
        elif (self.rightintent == "inproceedings"):
            if self.CurrentData == "year":
                # print ("Year:", self.year)
                self.ww.write("Year:" + self.year + "\n")
                # self.__class__.res=self.__class__.res+self.year+';,;'
        ...
        elif (tag == "inproceedings"): #在一个inproceedings tag结束时，下一次要重新判断
    ...
    def characters(self, content):
        ...
        if self.rightintent == "article":
            ...
            if self.CurrentData == "year":
                ...
                self.title += content
                # if "Foundational principles &amp; technologies for the metaverse." in content:
...
# dblp_path="/Users/yizhihenpidehou/Desktop/fdu/Metaverse-Analysis/xml2txt/dblp-test.xml"
# res_path='test_article.txt'
